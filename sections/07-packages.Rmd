...
Much of the source material for this section comes from [here](https://www.datacamp.com/community/tutorials/r-packages-guide).
...
1) Read the DESCRIPTION file for ```tidyr```. Read the description to get an idea of what it does.
